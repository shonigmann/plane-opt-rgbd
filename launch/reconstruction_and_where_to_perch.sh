...
if [ $# -eq 0 ]
  then
    echo "Invalid number of arguments. Usage: ./reconstruction_and_where_to_perch.sh [open3d_config_file_path] [open3d_reconstructed_mesh_path]"
    exit 0
fi
...
roslaunch /home/simon/catkin_ws/src/perch_placement/launch/where_to_perch.launch input_mesh:=~/catkin_ws/src/mesh_partition/models/cleaned_mesh.ply  # output_mesh:= segmented_mesh_clusters:=
